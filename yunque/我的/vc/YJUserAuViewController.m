...
@interface YJUserAuViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>{
...
@implementation YJUserAuViewController
                ...
                if (choseShopSortShopView.NameTextField.text.length) {
                    if (_defualtProvince.length) {
                        if (sectionRow>0) {
                            ...
                            [AnimationView showString:@"请选择h加盟类型"];
                        }
                    }else{
