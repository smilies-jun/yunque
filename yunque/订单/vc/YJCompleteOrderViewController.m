...
-(void)getNetworkData:(BOOL)isRefresh
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/app/order/queryOderList?pageNum=%d&pageSize=10&customerId=%@&orderStatus=102",BASE_URL,page,userID];
...
- (void)sureClick:(UIButton *)btn{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/app/order/completeOrder",BASE_URL];
