...
@interface YJShouCangViewController ()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>{
...
@implementation YJShouCangViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.TopView.hidden = NO;
    self.TopTitleLabel.text = @"上样历史";
...
-(void)getNetworkData:(BOOL)isRefresh
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/product/queryBycategoryId?userId=%@&categoryId=0",BASE_URL,userID];
