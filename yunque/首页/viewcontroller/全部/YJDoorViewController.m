...
@interface YJDoorViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
    NSArray *dataArray;
    NSString *cataIdStr;
}
...
@implementation YJDoorViewController
...
-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
     [[NSNotificationCenter defaultCenter] postNotificationName:@"secindex" object:@"1"];
}
/*
