...
@interface YJMenPeiViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
    NSArray *dataArray;
    NSString *cataIdStr;
...
@implementation YJMenPeiViewController
