...
@interface YJGongYiViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
    NSArray *dataArray;
    NSString *cataIdStr;
}
...
@implementation YJGongYiViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notification2:) name:@"door2" object:nil];
    [self reoadDate:@"2"];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"secindex" object:@"2"];
}
/*
/*
