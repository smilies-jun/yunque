...
@implementation YJShopUserPostTableViewCell
...
- (void)configUI:(NSIndexPath *)indexPath{
    ...
    _UpShopButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [_UpShopButton setBackgroundColor:font_main_color];
    _UpShopButton.titleLabel.font = [UIFont systemFontOfSize:13];
    [_UpShopButton setTitle:@"上样" forState:UIControlStateNormal];
    [self addSubview:_UpShopButton];
    [_UpShopButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.mas_equalTo(self.mas_right).offset(-20);
        make.bottom.mas_equalTo(self->_ShopNumberLabel.mas_bottom).offset(40);
