...
@implementation YJGouWuCheTableViewCell
...
- (void)setModel:(JSCartModel *)model{
    _ShopNameLabel.text = model.p_name;
    _ShopNumberLabel.text = [NSString stringWithFormat:@"%ld",(long)model.p_quantity];
    _ShopMoneyLabel.text = [NSString stringWithFormat:@"%ld",(long)model.p_price];
    [_ShopImageView sd_setImageWithURL:[NSURL URLWithString:model.p_imageUrl] placeholderImage:[UIImage imageNamed:@"imageDefault"]];
