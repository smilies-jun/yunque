//
//  YJXiaoShouLiangViewController.m
//  maike
//
...
@interface YJXiaoShouLiangViewController ()<ZFGenericChartDataSource, ZFBarChartDelegate,ZFWaveChartDelegate>{
...
@implementation YJXiaoShouLiangViewController
