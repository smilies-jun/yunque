...
@interface YJKeHuLiangViewController ()<ZFGenericChartDataSource, ZFBarChartDelegate,ZFWaveChartDelegate>{
...
@implementation YJKeHuLiangViewController
...
- (void)intChart{
    ...
    self.waveChart.topicLabel.text = @"客户量增长率";
