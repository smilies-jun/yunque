...
@protocol SYNetworkUploadDelegat <NSObject>
...
@interface SYNetWorkingUpLoad : NSObject
/**
 *  代理
 */
@property (weak, nonatomic) id<SYNetworkUploadDelegat> delegate;
/**
 *  初始化
 *
