...
-(NSString*)HDSelecterView:(HDSelecterView*)selecterView titlesWithLastSelected:(NSArray<HDSelecterItemModel*>*)lastSelecter atIndex:(NSInteger)index{
    if(lastSelecter.count == 0){
        return self.addressDatas[index][_MyFirstStr];
        
    }else if (lastSelecter.count == 1){
   
        return self.addressDatas[lastSelecter[0].index][_MySecondStr][index][_MyThirdStr];
    }else if (lastSelecter.count == 2){
        return self.addressDatas[lastSelecter[0].index][_MySecondStr][lastSelecter[1].index][_MyFourStr][index][_MyFiveStr];
    }else{
        return nil;
    }
}
...
-(void)HDSelecterView:(HDSelecterView *)selecterView completeSelected:(NSArray<HDSelecterItemModel *> *)selectItems{
    if (self.completeSelectBlock) {
        self.completeSelectBlock(self.addressDatas[selectItems[0].index][_MyFirstStr],
                                 self.addressDatas[selectItems[0].index][_categoryId], self.addressDatas[selectItems[0].index][_MySecondStr][selectItems[1].index][_MyThirdStr],
                                 self.addressDatas[selectItems[0].index][_MySecondStr][selectItems[1].index][_categoryId], self.addressDatas[selectItems[0].index][_MySecondStr][selectItems[1].index][_MyFourStr][selectItems[2].index][_MyFiveStr], self.addressDatas[selectItems[0].index][_MySecondStr][selectItems[1].index][_MyFourStr][selectItems[2].index][_categoryId]);
    }
}
